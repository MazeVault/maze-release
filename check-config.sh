...
REF_ENV_KEYS=(
  ...
  MAZEVAULT_CUSTOMER_NAME MAZEVAULT_CUSTOMER_EMAIL MAZEVAULT_COMPANY_ID MAZEVAULT_INSTANCE_ID
  ...
  COOKIE_SECURE ALLOWED_ORIGINS CORS_ALLOWED_ORIGINS SWAGGER_ENABLED LOG_LEVEL
  FRONTEND_PORT FRONTEND_HTTP_PORT BACKEND_PORT PORT DOCS_PORT DOCS_URL
  MAZEVAULT_REGION
...
OPTIONAL_ENV_KEYS=(
  ...
  MAZEVAULT_PRIMARY_ENVIRONMENTS MAZEVAULT_ENV_CANONICAL_ENFORCE
...
REF_BE_VARS=(
  ...
  MAZEVAULT_ENV MAZEVAULT_ORCHESTRATOR_MODE APP_VERSION PORT
  COOKIE_SECURE FRONTEND_URL ALLOWED_ORIGINS CORS_ALLOWED_ORIGINS SWAGGER_ENABLED OCSP_URL
  GIN_MODE RUN_MIGRATIONS LOG_LEVEL
  SMTP_HOST SMTP_PORT SMTP_USERNAME SMTP_PASSWORD SMTP_FROM
  O365_EMAIL_ENABLED O365_TENANT_ID O365_CLIENT_ID O365_CLIENT_SECRET
  O365_SENDER_EMAIL O365_AUTH_METHOD O365_CERTIFICATE_PATH O365_CERTIFICATE_PASSWORD O365_MANAGED_IDENTITY_CLIENT_ID
  ENTRA_CLIENT_ID ENTRA_CLIENT_SECRET ENTRA_TENANT_ID ENTRA_REDIRECT_URI MAZEVAULT_ENFORCE_OIDC_NONCE
  AZURE_AD_TENANT_ID AZURE_AD_ALLOWED_TENANTS AZURE_AD_JWKS_CACHE_TTL
  AZURE_MANAGED_IDENTITY_CLIENT_ID AZURE_TENANT_ID AZURE_DEPLOYMENT
  MAZEVAULT_CUSTOMER_NAME MAZEVAULT_CUSTOMER_EMAIL MAZEVAULT_COMPANY_ID MAZEVAULT_INSTANCE_ID MAZEVAULT_REGION
